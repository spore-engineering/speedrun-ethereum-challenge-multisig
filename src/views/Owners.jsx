      ...
      <div style={{border:"1px solid #cccccc", padding:16, width:400, margin:"auto",marginTop:64}}>
        <div style={{margin:8,padding:8}}>
          <Select value={methodName} style={{ width: "100%" }} onChange={ setMethodName }>
            ...
            <Option key="enableOwnerTransfer">enableOwnerTransfer()</Option>
          </Select>
        </div>
        <div style={{margin:8,padding:8}}>
          <AddressInput
        ...
        <div style={{margin:8,padding:8}}>
          <Input
            ...
            disabled={(methodName == "enableOwnerTransfer") ? true:false}
          />
        </div>
        <div style={{margin:8,padding:8}}>
          <Button onClick={()=>{
            ...
            if(methodName == "enableOwnerTransfer") {
              setNewSignaturesRequired(0);
              calldata = readContracts[contractName].interface.encodeFunctionData(methodName,[newOwner])
            }
            else {
              calldata = readContracts[contractName].interface.encodeFunctionData(methodName,[newOwner,newSignaturesRequired])
            }
